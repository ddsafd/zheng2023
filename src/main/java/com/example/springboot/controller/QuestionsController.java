...
public class QuestionsController {
    ...
    @GetMapping("/type")
    public Result chapters(@RequestParam String type,
    ...
    public Result save(@RequestBody Questions questions) {
        if (questions.getId() == null) {
            ...
            //questions.setUser(TokenUtils.getCurrentUser().getNickname());
...
//        }
        return Result.success(questionsService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Questions信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Questions> list = reader.readAll(Questions.class);

        questionsService.saveBatch(list);
        return Result.success();
    }
