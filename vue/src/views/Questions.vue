<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/questions/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" :header-cell-class-name="'headerBg'" border stripe
      ...
      <el-table-column label="选项A" prop="choiceA"></el-table-column>
      <el-table-column label="选项B" prop="choiceB"></el-table-column>
      <el-table-column label="选项C" prop="choiceC"></el-table-column>
      <el-table-column label="选项D" prop="choiceD"></el-table-column>
      <el-table-column label="解析" prop="explaination"></el-table-column>
      <el-table-column label="分值" prop="scores"></el-table-column>
    ...
    <el-dialog :close-on-click-modal="false" :visible.sync="dialogFormVisible" title="信息" width="40%">
      <el-form ref="ruleForm" :model="form" :rules="rules" label-width="140px" size="small" style="width: 85%;">
        ...
        <el-form-item label="解析" prop="explaination">
          <el-input v-model="form.explaination" autocomplete="off"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    save() {
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          this.request.post("/questions", this.form).then(res => {
            if (res.code === '200') {
    ...
    delBatch() {
      ...
      this.request.post("/questions/del/batch", ids).then(res => {
        if (res.code === '200') {
    ...
    exp() {
      window.open("http://localhost:9090/questions/export")
    },
