  ...
  <div>
    ...
    <div style="margin: 10px 0">
      <el-upload :on-success="handleFileUploadSuccess" :show-file-list="false"
                 action="http://localhost:9090/file/uploadImgHomePage" style="display: inline-block">
        <el-button class="ml-5" type="primary">上传文轮播图 <i class="el-icon-top"></i></el-button>
      </el-upload>
      <el-popconfirm
    ...
    <el-table :data="tableData" :header-cell-class-name="'headerBg'" border stripe
      ...
      <el-table-column label="大小(kb)" prop="size"></el-table-column>
      <el-table-column label="大小(kb)" prop="size"></el-table-column>
      <el-table-column label="图片">
        <template slot-scope="scope">
          <el-image :preview-src-list="[scope.row.url]" :src="scope.row.url"
