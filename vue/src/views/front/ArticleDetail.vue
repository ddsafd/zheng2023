<template>
  <div style="padding: 10px">
      ...
      <el-col :span="24">
        <el-card>
          <div class="item1" style="margin: 0 0 0 25px">
            <div>
              <span style="font-size: 23px;font-weight:bold;color: #E6A23C">{{ article.name }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div style="margin-top: 20px">
              ...
              <span style="color: #666666">收藏数</span>&nbsp;&nbsp;:&nbsp;&nbsp;<span
                style="color: #222">{{ article.collectCount }}</span>&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
          </div>
        </el-card>
      </el-col>
    ...
    <el-row :gutter="10" style="margin-top: 10px">
      <el-col :span="24">
        <el-card style="height: 480px;">
          <img :preview-src-list="[article.img]" :src="article.img"
    ...
    <el-card style="margin-top: 15px">
      ...
      <div style="margin-top: 15px" v-html="article.content"></div>
    </el-card>
...
export default {
  ...
  duration: 500  // 设置为1.5秒
      ...
      let data = {articleId: this.id, userId: this.user.id}
