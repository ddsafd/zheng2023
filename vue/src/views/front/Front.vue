    ...
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 300px; display: flex; padding-left: 30px">
        <div style="width: 50px">
          <img alt="" src="../../assets/gonggao.png" style="width: 40px; position: relative; top: 8px; right: 0">
        </div>
        <div style="flex: 1">欢迎来到诈骗预防宣传系统</div>
      </div>
      <div style="flex: 1">

        <el-menu :default-active="$route.path" class="el-menu-demo" mode="horizontal" router
                 style="border: none; height: 100%;margin-left: 50px">
          <el-menu-item index="/front/home">首页</el-menu-item>
          <el-menu-item index="/front/article">文章预览</el-menu-item>
          <el-menu-item index="/front/video">视频预览</el-menu-item>
          <el-menu-item index="/front/myCollect">我的文章收藏</el-menu-item>
        ...
        <div v-else>
          <el-dropdown style="width: 150px; cursor: pointer; text-align: right">
            ...
            <el-dropdown-menu slot="dropdown" style="width: 100px; text-align: center">
              <el-dropdown-item v-if="user.role === 'ROLE_ADMIN'" style="font-size: 14px; padding: 5px 0">
                <router-link to="/home">
                  <div>进入后台</div>
                </router-link>
              </el-dropdown-item>
